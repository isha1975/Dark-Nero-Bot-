...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94707330800,")
...
global.sudo = process.env.SUDO || '94707330800'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'DARK-NERO-BetaX 💗' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'SITHUM METHMIKA' : process.env.OWNER_NAME,
